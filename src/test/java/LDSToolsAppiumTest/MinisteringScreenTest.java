...
//        }
    ...
    @Test (dataProvider = "Members", groups = {"all4", "all", "smoke4", "jft"})
...
//        }
    ...
    @Test (dataProvider = "Members", groups = {"all2", "all", "smoke2"})
...
//    }
    ...
    @Test (dataProvider = "Members", groups = {"all1", "all", "smoke1"})
...
//        }
    ...
    @Test (dataProvider = "Members", groups = {"all4", "all", "smoke4"})
